...
${SUDO} apt-get update;
${SUDO} apt-get install -yq build-essential curl git wget;

# chrome OS deps
${SUDO} apt-get install -yq ca-certificates fonts-liberation libasound2 libatk-bridge2.0-0 libatk1.0-0 libc6 libcairo2\
